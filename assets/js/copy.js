...
$(window).resize(function() {
        ...
        null !== document.querySelector(".china-banner") && (ga("send", "event", "China_banner", "China_ban_impr"), $(".main").addClass("cn"), $(".china-banner").click(function() {
            ga("send", "event", "China_banner", "China_ban_click")
        }), $(".china-banner-close-btn").click(function() {
            $(".china-banner").addClass("china-banner-close china-banner-animate"), $(".main").removeClass("cn")
        }))
    }),
    function(e) {
        let i = $(".header");
        $("#toggle").on("click", function() {
            let e = $("#overlay");
            $(this).toggleClass("active"), e.toggleClass("open"), e.hasClass("open") ? i.addClass("open") : i.removeClass("open")
        }), i.find(".menu > li").clone().appendTo("#mobile_nav"), e > 1200 ? ($("#menu-redesign-menu .menu-item-has-children").hover(function() {
            $(this).addClass("active"), $(this).find(".sub-menu").show().animate({
                opacity: 1,
                top: "75px"
            }, 200)
        }, function() {
        ...
        }), $("#menu-redesign-menu .menu-item-has-children > a").on("click", function(e) {
            e.preventDefault()
        })) : $("#mobile_nav .menu-item-has-children > a").on("click", function(e) {
            let i = $(this).parent();
            i.hasClass("active") ? (i.find(".sub-menu").slideUp(400), i.removeClass("active")) : (i.find(".sub-menu").slideDown(400), i.addClass("active")), e.preventDefault()
        })
    }(width),
    function(e) {
        if (e > 992) {
            var i = function() {
                var i = $("#header.fixed"),
                    t = $(window).scrollTop();
                e < 1200 || (t > 0 ? i.addClass("scroll") : 0 === t && i.removeClass("scroll"))
            };
            $(window).on("scroll", i), $(window).on("load", i)
        }
    }(width),
    function(e) {
        e < 1200 && ($(".content__container .content__item").first().addClass("content__item--active"), $(".content__container .content__item").first().find(".content__body").css("display", "block"), $(".content__header").click(function(e) {
            e.stopPropagation();
            var i = $(this).closest(".content__item").find(".content__body");
            $(this).closest(".content__container").find(".content__body").not(i).slideUp(), $(this).parent().hasClass("content__item--active") ? $(this).parent().removeClass("content__item--active") : ($(".content__item").removeClass("content__item--active"), $(this).parent().addClass("content__item--active")), i.stop(!1, !0).slideToggle(function() {
                $("html, body").animate({
                    scrollTop: $(this).closest(".content__item").offset().top - 75
                }, 500)
            })
        }))
    }(width),
    function(e, i, t, o) {
        ...
        e.fn.lazyload = function(n) {
            ...
            return n && (o !== n.failurelimit && (n.failure_limit = n.failurelimit, delete n.failurelimit), o !== n.effectspeed && (n.effect_speed = n.effectspeed, delete n.effectspeed), e.extend(d, n)), l = d.container === o || d.container === i ? s : e(d.container), 0 === d.event.indexOf("scroll") && l.bind(d.event, function() {
                return r()
            }), this.each(function() {
                var i = this,
                    t = e(i);
                i.loaded = !1, (t.attr("src") === o || !1 === t.attr("src")) && t.is("img") && t.attr("src", d.placeholder), t.one("appear", function() {
                    if (!this.loaded) {
                        if (d.appear) {
                            var o = a.length;
                            d.appear.call(i, o, d)
                        ...
                        e("<img />").bind("load", function() {
                            var o = t.attr("data-" + d.data_attribute);
                            t.hide(), t.is("img") ? t.attr("src", o) : t.css("background-image", "url('" + o + "')"), t[d.effect](d.effect_speed), i.loaded = !0;
                            var s = e.grep(a, function(e) {
                                return !e.loaded
                            });
                            if (a = e(s), d.load) {
                                var n = a.length;
                        ...
                        }).attr("src", t.attr("data-" + d.data_attribute))
                    }
                }), 0 !== d.event.indexOf("scroll") && t.bind(d.event, function() {
                    i.loaded || t.trigger("appear")
                })
            }), s.bind("resize", function() {
                r()
            }), /(?:iphone|ipod|ipad).*os 5/gi.test(navigator.appVersion) && s.bind("pageshow", function(i) {
                i.originalEvent && i.originalEvent.persisted && a.each(function() {
            ...
            return (n.container === o || n.container === i ? (i.innerHeight ? i.innerHeight : s.height()) + s.scrollTop() : e(n.container).offset().top + e(n.container).height()) <= e(t).offset().top - n.threshold
        }, e.rightoffold = function(t, n) {
            return (n.container === o || n.container === i ? s.width() + s.scrollLeft() : e(n.container).offset().left + e(n.container).width()) <= e(t).offset().left - n.threshold
        }, e.abovethetop = function(t, n) {
            return (n.container === o || n.container === i ? s.scrollTop() : e(n.container).offset().top) >= e(t).offset().top + n.threshold + e(t).height()
        }, e.leftofbegin = function(t, n) {
            return (n.container === o || n.container === i ? s.scrollLeft() : e(n.container).offset().left) >= e(t).offset().left + n.threshold + e(t).width()
        }, e.inviewport = function(i, t) {
            return !(e.rightoffold(i, t) || e.leftofbegin(i, t) || e.belowthefold(i, t) || e.abovethetop(i, t))
        }, e.extend(e.expr[":"], {
    ...
    }(jQuery, window, document), $("img[data-original]").lazyload({
        effect: "fadeIn"
    }),
    function(e) {
    ...
    function() {
        const e = document.querySelector("[data-crm-widget=emailCollector]"),
            i = /^[a-z0-9._-]+@([a-z0-9-]+\.)+[a-z]{2,}$/i;
        e && e.addEventListener("ready", function() {
            const e = document.querySelector("#collectorform-email"),
                t = document.querySelector("#email-collector-btn"),
                o = document.querySelector(".field-collectorform-email .help-block");
            t.addEventListener("click", t => {
                if (!i.test(e.value)) return t.preventDefault(), e.classList.add("error-email"), o.innerText = "Please enter your E-mail", !1
            }), e.addEventListener("focus", () => {
                e.classList.remove("error-email"), e.parentNode.parentNode.style.marginBottom = 0, o.innerText = ""
            })
        })
    }(),
    function(e) {
        var i = $(".about-banner-slider ul");
        i.slick({
            infinite: !0,
            slidesToShow: 3,
            slidesToScroll: 1,
        ...
        }), e > 767 && i.on("mousewheel DOMMouseScroll", function(e) {
            e.originalEvent.wheelDelta >= 0 || e.originalEvent.detail < 0 ? i.slick("slickPrev") : i.slick("slickNext"), e.preventDefault()
        })
    }(width);