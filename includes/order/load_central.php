                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group-1">
                                    ...
                                    <div class="edulevel-row row">
                                        <div class="edulevel col-xs-6 col-sm-6 col-md-3 my-1 px-1">
                                            <div class="custom-radio-light">
                                                ...
                                                <label class="rad-label paper_standard-label" for="hschool">
                                                    <span class="rad-text" for="hschool">High School</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="edulevel col-xs-6 col-sm-6 col-md-3 my-1 px-1">
                                            <div class="custom-radio-light">
                                                ...
                                                <label class="rad-label paper_standard-label" for="ugrad">
                                                    <span class="rad-text" for="ugrad">Undergraduate</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="edulevel col-xs-6 col-sm-6 col-md-3 my-1 px-1">
                                            <div class="custom-radio-light">
                                                ...
                                                <label class="rad-label paper_standard-label" for="master">
                                                    <span class="rad-text" for="master">Masters</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="edulevel col-xs-6 col-sm-6 col-md-3 my-1 px-1">
                                            <div class="custom-radio-light">
                                                ...
                                                <label class="rad-label paper_standard-label" for="phd">
                                                    <span class="rad-text" for="phd">PhD</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group-1">
                                    ...
                                    <div class="edulevel-row row">
                                        <div class="edulevel col custom-radio-light" id="first">
                                            <input type="radio" id="single" name="spacing" value="Single">
                                            <label for="single">Single</label>
                                        </div>
                                        <div class="edulevel col custom-radio-light" id="last">
                                ...
                                <div class="form-group-1">
                                    ...
                                    <div class="edulevel-row row">
                                        <div class="edulevel col-xs-3 col-sm-3 col-md" id="first">
                                            <label class="deadline-label custom-radio-light" for="4h">
                                        ...
                                        <div class="edulevel col-xs-3 col-sm-3 col-md" id="second">
                                            <label class="deadline-label custom-radio-light" for="8h">
                                        ...
                                        <div class="edulevel col-xs-3 col-sm-3 col-md" id="third">
                                            <label class="deadline-label custom-radio-light" for="24h">
                                        ...
                                        <div class="edulevel col-xs-3 col-sm-3 col-md">
                                            <label class="deadline-label custom-radio-light" for="2d">
                                        ...
                                        <div class="edulevel col-xs-3 col-sm-3 col-md">
                                            <label class="deadline-label custom-radio-light" for="3d">
                                        ...
                                        <div class="edulevel col-xs-3 col-sm-3 col-md">
                                            <label class="deadline-label custom-radio-light" for="5d">
                                        ...
                                        <div class="edulevel col-xs-3 col-sm-3 col-md">
                                            <label class="deadline-label custom-radio-light" for="7d">
                                        ...
                                        <div class="edulevel col-xs-3 col-sm-3 col-md" id="last">
                                            <label class="deadline-label custom-radio-light" for="14d">
                                            ...
                                            <label for="best-avail" id="preferences">
                                                <div class="d-inline-block w-100">
                                                    <div class="m-0 d-flex flex-wrap justify-content-between align-center">
                                                        <span class="pref-label">Best Available</span>
                                                    </div>
                                                    <hr>
                                                    <small>standard writer</small>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="edulevel col custom-radio-light" id="second">
                                            ...
                                            <label for="advanced" id="preferences">
                                                <div class="d-inline-block w-100">
                                                    <div class="m-0 d-flex flex-wrap justify-content-between align-center">
                                                        <span class="pref-label">Advanced</span> 
                                                        <span>+15%</span>
                                                    </div>
                                                    <hr>
                                                    <small>Expert writer in the chosen discipline</small>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="edulevel col custom-radio-light" id="last">
                                            ...
                                            <label for="t10" id="preferences">
                                                <div class="d-inline-block w-100">
                                                    <div class="m-0 d-flex flex-wrap justify-content-between align-center">
                                                        <span class="pref-label">Top 10</span> 
                                                        <span>+40%</span>
                                                    </div>
                                                    <hr>
                                                    <small>Highest-ranked expert writer in the chosen discipline</small>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group clearfix">
                                    ...
                                    <input type="tel" class="form-control phone1 w-100" value="" id="phone1" name="phone1"
                                        placeholder="Phone" data-parsley-group="block1" required tabindex="14">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group-1">
                                    ...
                                    <div class="edulevel-row row">
                                        <div class="edulevel col-xs-12 col-sm-6 col-md px-1 my-1" id="first">
                                            <div class="custom-radio-light">
                                        ...
                                        <div class="edulevel col-xs-12 col-sm-6 col-md px-1 my-1" id="second">
                                            <div class="custom-radio-light">
                                        ...
                                        <div class="edulevel col-xs-12 col-sm-6 col-md px-1 my-1" id="third">
                                            <div class="custom-radio-light">
                                        ...
                                        <div class="edulevel col-xs-12 col-sm-6 col-md px-1 my-1">
                                            <div class="custom-radio-light">
                                        ...
                                        <div class="edulevel col-xs-12 col-sm-6 col-md px-1 my-1" id="last">
                                            <div class="custom-radio-light">
